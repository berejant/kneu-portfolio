...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_autosize__ = __webpack_require__(7);
...
$.fn.autosize = function () {
    __WEBPACK_IMPORTED_MODULE_1_autosize___default.a(this.find('textarea'));
    __WEBPACK_IMPORTED_MODULE_1_autosize___default.a(this);
    return this;
};

__WEBPACK_IMPORTED_MODULE_1_autosize___default.a(document.getElementsByTagName('textarea'));
...
$('.portfolio-edit-form').on('keyup change', '.js-endless-list :input', function (e) {
    var $inputContainer = $(this).closest('.js-endless-list');
    if ($.trim(this.value)) {
        $inputContainer.clone().insertAfter($inputContainer).find(':input').val('');

        var randomKey = '[new' + Math.ceil(Math.random() * 1E5) + ']';
        $inputContainer.removeContainerIfEmptyInput().removeClass('js-endless-list').autosize().find('input').each(function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_autosize__ = __webpack_require__(7);
